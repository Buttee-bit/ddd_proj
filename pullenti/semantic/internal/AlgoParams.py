...
class AlgoParams:
    ...
    def _static_ctor():
        ...
        AlgoParams.PARAMS.append(AlgoParam._new3681("TransitiveCoef", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("NextModel", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("NgLink", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("List", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("VerbPlural", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("CaseAccord", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3681("MorphAccord", 1, 3, 1))
