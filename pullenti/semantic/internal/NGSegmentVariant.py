...
class NGSegmentVariant(object):
    ...
    def calc_coef(self) -> float:
        ...
        while True:
            ...
            first_pass4342 = True
            while True:
                if first_pass4342: first_pass4342 = False
                else: k += 1
                if (not (k < i)): break
                li = self.links[k]
                if (li is None): 
        ...
        first_pass4343 = True
        while True:
            if first_pass4343: first_pass4343 = False
            else: i += 1
            if (not (i < len(self.links))): break
            ...
            if (k >= (len(list0_) - 1) and list0_[k].and_before): 
                ...
                if (k >= len(list0_)): 
                    ...
                    self.coef = -1
                    return self.coef
            ngli = NGLink._new3710(NGLinkType.LIST)
            k = 0
            ...
            if (not ok or lalink is None): 
                continue
            test = NGLink._new3711(lalink.from0_, lalink.typ)
            j = 0
            j = 0
        ...
        first_pass4344 = True
        while True:
            if first_pass4344: first_pass4344 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
        ...
        first_pass4345 = True
        while True:
            if first_pass4345: first_pass4345 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
        ...
        first_pass4346 = True
        while True:
            if first_pass4346: first_pass4346 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
    ...
    def get_list(self, ord0_ : int) -> typing.List['NGItem']:
        ...
        if (li.typ == NGLinkType.LIST): 
            if (li.to_verb is None): 
                return None
            res = list()
            res.append(NGItem._new3712(SentItem(li.to_verb), ord0_ - 1))
            res.append(ngit)
        i = ord0_ + 1
        first_pass4347 = True
        while True:
            if first_pass4347: first_pass4347 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
    ...
    def correct_morph(self) -> None:
        ...
        first_pass4348 = True
        while True:
            if first_pass4348: first_pass4348 = False
            else: i += 1
            if (not (i < len(self.links))): break
            li = self.links[i]
            if (li is None): 
    ...
    @staticmethod
    def _new3709(_arg1 : 'NGSegment') -> 'NGSegmentVariant':
