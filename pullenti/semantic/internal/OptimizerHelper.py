...
class OptimizerHelper:
    ...
    def __process_participles(gr : 'SemGraph') -> bool:
        ...
        first_pass4349 = True
        while True:
            if first_pass4349: first_pass4349 = False
            else: i += 1
            ...
            if (not has): 
                continue
            if (own is None): 
                dum = SemObject._new3713(gr, SemObjectType.NOUN)
                if (obj.morph is not None): 
                    dum.morph = MorphWordForm._new3714(MorphClass.NOUN, obj.morph.number, obj.morph.gender, obj.morph.case_)
    ...
    def __collapse_anafors(gr : 'SemGraph') -> bool:
        ...
        first_pass4350 = True
        while True:
            if first_pass4350: first_pass4350 = False
            else: i += 1
            if (not (i < len(gr.objects))): break
            obj = gr.objects[i]
    ...
    def __process_formulas(objs : typing.List['SemObject']) -> bool:
        ...
        first_pass4351 = True
        while True:
            if first_pass4351: first_pass4351 = False
            else: i += 1
    ...
    def __process_pointers(objs : typing.List['SemObject']) -> bool:
        ...
        first_pass4352 = True
        while True:
            if first_pass4352: first_pass4352 = False
            else: i += 1
            if (not (i < len(objs))): break
            o = objs[i]
            ...
            if (not ok): 
                ...
                first_pass4353 = True
                while True:
                    if first_pass4353: first_pass4353 = False
                    else: j += 1
            ...
            if (not ok): 
                continue
            first = SemObject._new3713(o.graph, SemObjectType.ADJECTIVE)
        ...
        first_pass4354 = True
        while True:
            if first_pass4354: first_pass4354 = False
            else: i += 1
            if (not (i < len(objs))): break
            o = objs[i]
            if (o.typ != SemObjectType.NOUN): 
