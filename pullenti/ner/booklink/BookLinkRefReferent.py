...
class BookLinkRefReferent(Referent):
    ...
    def get_number_diff(r1 : 'Referent', r2 : 'Referent') -> int:
        ...
        n1 = 0
        n2 = 0
        wrapn1529 = RefOutArgWrapper(0)
        inoutres530 = Utils.tryParseInt(num1, wrapn1529)
        wrapn2531 = RefOutArgWrapper(0)
        inoutres532 = Utils.tryParseInt(num2, wrapn2531)
        n1 = wrapn1529.value
        n2 = wrapn2531.value
        if (not inoutres530 or not inoutres532): 
            return None
        return n2 - n1
    
    @staticmethod
    def _new520(_arg1 : 'Referent') -> 'BookLinkRefReferent':
