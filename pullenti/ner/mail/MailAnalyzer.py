        ...
        while True:
            ...
            if (lines[0].typ == MailLine.Types.FROM): 
                ...
                while i < len(lines): 
                    if (lines[i].typ == MailLine.Types.FROM): 
                        ...
                        break
                    i += 1
                mail_ = MailReferent._new2235(MailKind.HEAD)
            ...
            while ii < len(lines): 
                if (lines[ii].typ == MailLine.Types.HELLO): 
                    mail_ = MailReferent._new2235(MailKind.HELLO)
            ...
            if (i0 < len(lines)): 
                if (t2 is not None and t2.previous is None): 
                    ...
                    if (tt00.begin_char > tt11.end_char): 
                        ...
                        mail_ = MailReferent._new2235(MailKind.BODY)
                        ...
                        if (mt.length_char > 0): 
                            ...
                            mail_.add_occurence_of_ref_tok(mt)
                if (t2 is not None): 
                    mail_ = MailReferent._new2235(MailKind.TAIL)
