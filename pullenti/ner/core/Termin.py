...
class Termin:
    ...
    class Term:
        ...
        @staticmethod
        def _new2643(_arg1 : 'TextToken', _arg2 : bool) -> 'Term':
    ...
    class Abridge:
        ...
        def add_part(self, val : str, has_delim : bool=False) -> None:
            self.parts.append(Termin.AbridgePart._new737(val, has_delim))
        ...
        def try_attach(self, t0 : 'Token') -> 'TerminToken':
            ...
            if (self.tail is None): 
                ...
                while i < len(self.parts): 
                    ...
                    tt = tt.next0_
                    i += 1
                res = TerminToken._new738(t0, te, t0 == te)
                if (point): 
    ...
    class AbridgePart:
        ...
        @staticmethod
        def _new737(_arg1 : str, _arg2 : bool) -> 'AbridgePart':
        ...
        @staticmethod
        def _new739(_arg1 : str) -> 'AbridgePart':
            res = Termin.AbridgePart()
            res.value = _arg1
            return res
    ...
    def add_abridge(self, abr : str) -> 'Abridge':
        ...
        if (i == 0): 
            return None
        a.parts.append(Termin.AbridgePart._new739(abr[0:0+i].upper()))
                ...
                if (str.isalpha(abr[i])): 
                    ...
                    while j < len(abr): 
                        if (not str.isalpha(abr[j])): 
                            break
                        j += 1
                    p = Termin.AbridgePart._new739(abr[i:i+j - i].upper())
                    if (j < len(abr)): 
        ...
        if (self.acronym_smart is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO) and term is not None): 
            if (self.acronym_smart == term or self.acronym_smart == term0): 
                if (t0.next0_ is not None and t0.next0_.is_char('.') and not t0.is_whitespace_after): 
                    return TerminToken._new563(t0, t0.next0_, self)
                else: 
                    return TerminToken._new563(t0, t0, self)
            i = 0
            t1 = Utils.asObjectOrNull(t0, TextToken)
            ...
            if (i >= len(self.acronym)): 
                return TerminToken._new563(t0, t1, self)
        ...
        if (len(self.terms) > 0 and ((not self.ignore_terms_order or cou == 1))): 
            ...
            if (ok and i >= len(self.terms)): 
                ...
                if (has_bracket and BracketHelper.can_be_end_of_sequence(t1.next0_, False, None, False)): 
                    t1 = t1.next0_
                return TerminToken._new746(t0, t1, mc)
    ...
    def try_parse_sim(self, t0 : 'Token', simd : float, pars : 'TerminParseAttr'=TerminParseAttr.NO) -> 'TerminToken':
        ...
        if (len(self.terms) > 0): 
            ...
            return TerminToken._new752(t0, t1, mc, self)
        if (self.abridges is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO)): 
            res = None
            for a in self.abridges: 
                r = a.try_attach(t0)
    ...
    @staticmethod
    def _new155(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        return res
    
    @staticmethod
    def _new156(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        return res
    ...
    @staticmethod
    def _new157(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        return res
    ...
    @staticmethod
    def _new159(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new162(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new172(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new183(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
    ...
    @staticmethod
    def _new184(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
    ...
    @staticmethod
    def _new191(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new197(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new203(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new204(_arg1 : str, _arg2 : object, _arg3 : str) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        return res
    ...
    @staticmethod
    def _new207(_arg1 : str, _arg2 : object, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
    ...
    @staticmethod
    def _new250(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : str, _arg5 : bool, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new294(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        return res
    ...
    @staticmethod
    def _new295(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new297(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new298(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new338(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new339(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new342(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphLang', _arg5 : object, _arg6 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new343(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new347(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new505(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        return res
    
    @staticmethod
    def _new573(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object) -> 'Termin':
    ...
    @staticmethod
    def _new703(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag = _arg4
        return res
    
    @staticmethod
    def _new857(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        return res
    
    @staticmethod
    def _new1170(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        return res
    
    @staticmethod
    def _new1171(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        return res
    
    @staticmethod
    def _new1182(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.tag2 = _arg4
        return res
    ...
    @staticmethod
    def _new1186(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.acronym = _arg4
        return res
    ...
    @staticmethod
    def _new1192(_arg1 : str, _arg2 : str, _arg3 : 'MorphLang', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.lang = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new1196(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1198(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : str, _arg5 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.acronym = _arg4
        res.tag2 = _arg5
    ...
    @staticmethod
    def _new1269(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        res.tag = _arg4
        return res
    ...
    @staticmethod
    def _new1307(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
    ...
    @staticmethod
    def _new1315(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.tag2 = _arg4
        res.tag3 = _arg5
    ...
    @staticmethod
    def _new1427(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        return res
    
    @staticmethod
    def _new1481(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        return res
    
    @staticmethod
    def _new1484(_arg1 : str, _arg2 : str, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        return res
    ...
    @staticmethod
    def _new1495(_arg1 : str, _arg2 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.ignore_terms_order = _arg2
        return res
    
    @staticmethod
    def _new1544(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
    ...
    @staticmethod
    def _new1546(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new1592(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag3 = _arg2
        return res
    
    @staticmethod
    def _new1623(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1624(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1626(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1672(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1688(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1699(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.acronym_can_be_smart = _arg4
    ...
    @staticmethod
    def _new1709(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1724(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1728(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_smart = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1736(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1737(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1743(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1748(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : bool, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1848(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin()
        res.acronym = _arg1
        res.lang = _arg2
        return res
    ...
    @staticmethod
    def _new2137(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.acronym = _arg3
        return res
    
    @staticmethod
    def _new3125(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        return res
    
    @staticmethod
    def _new3410(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag2 = _arg4
        return res
    
    @staticmethod
    def _new3502(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3512(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3525(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        res.tag = _arg5
        res.tag2 = _arg6
    ...
    @staticmethod
    def _new3529(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new3541(_arg1 : str, _arg2 : object, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.ignore_terms_order = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new3579(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
