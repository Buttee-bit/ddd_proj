...
class MetaInstrumentBlock(ReferentClass):
    ...
    def initialize() -> None:
        ...
        MetaInstrumentBlock.GLOBAL_META.kind_feature.add_value(Utils.enumToString(InstrumentKind.FOOTNOTE), "Сноска", None, None)
        ...
        MetaInstrumentBlock.GLOBAL_META.add_feature(InstrumentBlockReferent.ATTR_TABLECOLUMNS, "Число столбцов таблицы", 0, 1)
