...
class DateReferent(Referent):
    ...
    def calculate_date_range(self, now : datetime.datetime, from0_ : datetime.datetime, to : datetime.datetime, tense : int=0) -> bool:
        ...
        """
        from pullenti.ner.date.internal.DateRelHelper import DateRelHelper
        inoutres1018 = DateRelHelper.calculate_date_range(self, now, from0_, to, tense)
        return inoutres1018
        ...
        if (self.is_relative): 
            ...
            for s in self.slots: 
                if (s.type_name == DateReferent.ATTR_CENTURY): 
                    ...
                    word = "минута"
                    wrapval1030 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1030)
                    val = wrapval1030.value
                elif (s.type_name == DateReferent.ATTR_DAYOFWEEK): 
                    wrapval1031 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1031)
                    val = wrapval1031.value
                    if (not is_local_rel): 
    ...
    @staticmethod
    def _new930(_arg1 : 'DateReferent', _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        res.day = _arg2
        return res
    ...
    @staticmethod
    def _new931(_arg1 : int, _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        res.day = _arg2
        return res
    ...
    @staticmethod
    def _new932(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.year = _arg1
        return res
    ...
    @staticmethod
    def _new939(_arg1 : 'DatePointerType') -> 'DateReferent':
        res = DateReferent()
        res.pointer = _arg1
        return res
    
    @staticmethod
    def _new951(_arg1 : int, _arg2 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        res.higher = _arg2
        return res
    ...
    @staticmethod
    def _new956(_arg1 : int, _arg2 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.day = _arg1
        res.higher = _arg2
        return res
    ...
    @staticmethod
    def _new969(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        return res
    
    @staticmethod
    def _new971(_arg1 : int, _arg2 : int, _arg3 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.hour = _arg1
        res.minute = _arg2
        res.higher = _arg3
    ...
    @staticmethod
    def _new990(_arg1 : int, _arg2 : bool) -> 'DateReferent':
        res = DateReferent()
        res.century = _arg1
    ...
    @staticmethod
    def _new991(_arg1 : int, _arg2 : bool) -> 'DateReferent':
        res = DateReferent()
        res.decade = _arg1
        res.is_relative = _arg2
        return res
    ...
    @staticmethod
    def _new998(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.day = _arg1
        return res
    
    @staticmethod
    def _new1000(_arg1 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        return res
    
    @staticmethod
    def _new1001(_arg1 : 'DateReferent', _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        res.month = _arg2
        return res
    ...
    @staticmethod
    def _new1011(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
