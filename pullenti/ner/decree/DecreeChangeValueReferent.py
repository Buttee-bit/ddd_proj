...
class DecreeChangeValueReferent(Referent):
    ...
    def begin_char(self) -> int:
        ...
        if (val is None): 
            return 0
        n = 0
        wrapn1420 = RefOutArgWrapper(0)
        inoutres1421 = Utils.tryParseInt(val, wrapn1420)
        n = wrapn1420.value
        if (inoutres1421): 
            return n
        return 0
    ...
    def end_char(self) -> int:
        ...
        if (val is None): 
            return 0
        n = 0
        wrapn1422 = RefOutArgWrapper(0)
        inoutres1423 = Utils.tryParseInt(val, wrapn1422)
        n = wrapn1422.value
        if (inoutres1423): 
            return n
        return 0
    ...
    @staticmethod
    def _new1047(_arg1 : 'DecreeChangeValueKind') -> 'DecreeChangeValueReferent':
