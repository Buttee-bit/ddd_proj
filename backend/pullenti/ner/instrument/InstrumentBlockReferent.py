...
class InstrumentBlockReferent(Referent):
    ...
    def number(self) -> int:
        ...
        inoutres2179 = Utils.tryParseInt(str0_, wrapi2178)
        i = wrapi2178.value
        if (inoutres2179): 
            return i
        return 0
    ...
    def sub_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2180 = RefOutArgWrapper(0)
        inoutres2181 = Utils.tryParseInt(str0_, wrapi2180)
        i = wrapi2180.value
        if (inoutres2181): 
            return i
        return 0
    ...
    def sub_number2(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2182 = RefOutArgWrapper(0)
        inoutres2183 = Utils.tryParseInt(str0_, wrapi2182)
        i = wrapi2182.value
        if (inoutres2183): 
            return i
        return 0
    ...
    def sub_number3(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2184 = RefOutArgWrapper(0)
        inoutres2185 = Utils.tryParseInt(str0_, wrapi2184)
        i = wrapi2184.value
        if (inoutres2185): 
            return i
        return 0
    ...
    def min_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2186 = RefOutArgWrapper(0)
        inoutres2187 = Utils.tryParseInt(str0_, wrapi2186)
        i = wrapi2186.value
        if (inoutres2187): 
            return i
        return 0
