...
class PartToken(MetaToken):
    ...
    class PartValue(MetaToken):
        ...
        def int_value(self) -> int:
            if (Utils.isNullOrEmpty(self.value)): 
                return 0
            num = 0
            wrapnum1303 = RefOutArgWrapper(0)
            inoutres1304 = Utils.tryParseInt(self.value, wrapnum1303)
            num = wrapnum1303.value
            if (inoutres1304): 
                return num
            return 0
        ...
        def correct_value(self) -> None:
            ...
            while True:
                ...
                if ((t.is_hiphen and not t.is_whitespace_after and (isinstance(t.next0_, NumberToken))) and t.next0_.int_value is not None): 
                    n1 = 0
                    wrapn11305 = RefOutArgWrapper(0)
                    inoutres1306 = Utils.tryParseInt(self.value, wrapn11305)
                    n1 = wrapn11305.value
                    if (inoutres1306): 
        ...
        @staticmethod
        def _new1309(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'PartValue':
    ...
    def add_value(self, add : int) -> bool:
        if (len(self.values) != 1): 
            return False
        n = 0
        wrapn1307 = RefOutArgWrapper(0)
        inoutres1308 = Utils.tryParseInt(Utils.ifNotNull(self.values[0].value, ""), wrapn1307)
        n = wrapn1307.value
        if (not inoutres1308): 
            return False
        n += add
    ...
    def try_attach(t : 'Token', prev : 'PartToken', in_bracket : bool=False, ignore_number : bool=False) -> 'PartToken':
        ...
        if ((isinstance(t, NumberToken)) and t.next0_ is not None and (t.whitespaces_after_count < 3)): 
            ...
            if (re is not None): 
                ...
                if (ok1 or in_bracket): 
                    re.begin_token = t
                    for n in nums: 
                        re.values.append(PartToken.PartValue._new1309(n, n, n.value))
                    return re
        if (t.is_value("ПОСЛЕДНИЙ", None)): 
            re = PartToken.__create_part_typ0(t.next0_, None)
            if (re is not None): 
                re.begin_token = t
                re.values.append(PartToken.PartValue._new1309(t, t, t.get_normal_case_text(MorphClass.ADJECTIVE, MorphNumber.SINGULAR, MorphGender.UNDEFINED, False)))
                return re
                ...
                if (t0.is_char('(') and t.next0_ is not None): 
                    if (t.next0_.is_value("ЧАСТЬ", None) or t.next0_.is_value("Ч", None)): 
                        ...
                        if (te.next0_ is not None and te.next0_.is_char('.')): 
                            te = te.next0_
                        res = PartToken._new1027(t, te, PartToken.ItemType.PART)
                        res.values.append(PartToken.PartValue._new1309(t, t, str(t.value)))
                        return res
                return None
            if (dr.clause is None): 
                return None
            res = PartToken._new1313(t, t, PartToken.ItemType.CLAUSE, not delim)
            pv = PartToken.PartValue._new1309(t, t, str(t.value))
        ...
        if (((isinstance(t, NumberToken)) and t.typ == NumberSpellingType.DIGIT and prev is not None) and prev.typ == PartToken.ItemType.PREFIX and (t.whitespaces_before_count < 3)): 
            ...
            if (ne is not None and ne.typ == DecreeToken.ItemType.TYP): 
                ...
                ok = True
            if (ok): 
                res = PartToken._new1027(t, pv.end_token, PartToken.ItemType.ITEM)
                res.values.append(pv)
                return res
        if (tt is None): 
            return None
        ...
        if (res is not None): 
            ...
            if (t1.is_value("ПОЛОЖЕНИЕ", None) and prev is not None and not t1.chars.is_all_lower): 
                return None
            res = PartToken._new1027(t1, t1, PartToken.ItemType.PREFIX)
            ...
            if (t1.next0_ is not None and t1.next0_.is_value("ПО", None)): 
                t1 = t1.next0_
            return PartToken._new1027(t, t1, PartToken.ItemType.PREFIX)
            ...
            rr = PartToken._new1027(t1, t1.next0_, PartToken.ItemType.PART)
            rr.values.append(PartToken.PartValue._new1309(t1, t1, ("мотивировочная" if t1.is_value("МОТИВИРОВОЧНЫЙ", None) or t1.is_value("МОТИВУВАЛЬНИЙ", None) else "резолютивная")))
            return rr
        if (res is None): 
        ...
        while t1 is not None:
            ...
            if (BracketHelper.can_be_start_of_sequence(t1, False, False)): 
                ...
                while True:
                    ...
                    if (isinstance(ttt, NumberToken)): 
                        ...
                        if (newp is None): 
                            newp = list()
                        pv0 = PartToken.PartValue._new1309(ttt, ttt, str(ttt.value))
                        pv0.correct_value()
                        ttt = pv0.end_token
                        newp.append(pv0)
                        continue
                    ...
                    if (newp is None): 
                        newp = list()
                    pv = PartToken.PartValue._new1309(ttt, ttt, to.term)
                ...
                if (t1 is not None and t1.is_hiphen and BracketHelper.can_be_start_of_sequence(t1.next0_, False, False)): 
                    ...
                    if (br1 is not None and (isinstance(t1.next0_.next0_, TextToken)) and t1.next0_.next0_.length_char == 1): 
                        pv = PartToken.PartValue._new1309(br1.begin_token, t1.next0_.next0_, t1.next0_.next0_.term)
                        pv.correct_value()
            ...
            if (((isinstance(t1, TextToken)) and t1.length_char == 1 and t1.chars.is_letter) and len(res.values) == 0): 
                if (t1.chars.is_all_upper and res.typ == PartToken.ItemType.SUBPROGRAM): 
                    res.values.append(PartToken.PartValue._new1309(t1, t1, t1.term))
                    res.end_token = t1
                    return res
                ok = True
                lev = 0
                ...
                if (ok and t1.next0_ is not None and t1.next0_.is_char(')')): 
                    res.values.append(PartToken.PartValue._new1309(t1, t1.next0_, t1.term))
                    res.end_token = t1.next0_
                    t1 = t1.next0_.next0_
                    continue
                if (((ok and t1.next0_ is not None and t1.next0_.is_char_of("(.[")) and not t1.next0_.is_whitespace_after and (isinstance(t1.next0_.next0_, NumberToken))) and t1.next0_.next0_.next0_ is not None and t1.next0_.next0_.next0_.is_char_of(")]")): 
                    res.values.append(PartToken.PartValue._new1309(t1, t1.next0_.next0_.next0_, "{0}.{1}".format(t1.term, t1.next0_.next0_.value)))
                ...
                if ((t1.is_value("З", None) and t1.chars.is_all_upper and res.typ != PartToken.ItemType.INDENTION) and res.typ != PartToken.ItemType.SUBITEM): 
                    val = PartToken.PartValue._new1309(t1, t1, "3")
                    val.correct_value()
            ...
            if (isinstance(t1, NumberToken)): 
                ...
                if (len(res.values) > 0): 
                    ...
                    if (t1.typ != ntyp): 
                        break
                ntyp = t1.typ
                val = PartToken.PartValue._new1309(tt0, t1, str(t1.value))
                val.correct_value()
                res.values.append(val)
                res.end_token = val.end_token
                t1 = res.end_token.next0_
            ...
            if (nt is not None): 
                pv = PartToken.PartValue._new1309(t1, nt.end_token, str(nt.value))
                res.values.append(pv)
                pv.correct_value()
            ...
            if ((t1 == tt1 and ((res.typ == PartToken.ItemType.APPENDIX or res.typ == PartToken.ItemType.ADDAGREE)) and t1.is_value("К", None)) and t1.next0_ is not None): 
                if ((isinstance(t1.next0_.get_referent(), DecreeReferent)) or DecreeToken.is_keyword(t1.next0_, False) is not None or DecreeToken.is_keyword(t1.next0_.next0_, False) is not None): 
                    res.values.append(PartToken.PartValue._new1309(t1, t1, ""))
                    break
            if (res.typ == PartToken.ItemType.ADDAGREE and first_num_prefix is not None and len(res.values) == 0): 
                ...
                if (ddd is not None and ddd.typ == DecreeToken.ItemType.NUMBER and ddd.value is not None): 
                    if (t1.begin_char <= ddd.begin_char): 
                        res.values.append(PartToken.PartValue._new1309(t1, ddd.end_token, ddd.value))
            ...
            if (t1.is_hiphen): 
                ...
                if ((max0_ - min0_) > 200): 
                    break
                val = PartToken.PartValue._new1309(t1.next0_, (t1.next0_ if nmax == t1.next0_ else nmax.end_token), str(max0_))
                val.correct_value()
                res.values.append(val)
                res.end_token = val.end_token
                t1 = res.end_token.next0_
        ...
        if (len(res.values) == 0 and res.name is None): 
            if (((not ignore_number and res.typ != PartToken.ItemType.PREAMBLE and res.typ != PartToken.ItemType.NAME) and res.typ != PartToken.ItemType.TABLE and res.typ != PartToken.ItemType.SUBPROGRAM) and res.typ != PartToken.ItemType.NOTICE and res.typ != PartToken.ItemType.FOOTNOTE): 
                return None
    ...
    def __create_part_typ0(t1 : 'Token', prev : 'PartToken') -> 'PartToken':
        is_short = False
        wrapis_short1335 = RefOutArgWrapper(False)
        pt = PartToken.__create_part_typ(t1, prev, wrapis_short1335)
        is_short = wrapis_short1335.value
        if (pt is None): 
            return None
        if (t1.length_char > 4): 
            pt.morph = t1.morph
    ...
    def __create_part_typ(t1 : 'Token', prev : 'PartToken', is_short : bool) -> 'PartToken':
        ...
        if (t1.is_value("ЧАСТЬ", "ЧАСТИНА") or t1.is_value("PART", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.PART)
        ...
        if (t1.is_value("ГЛАВА", None) or t1.is_value("ГЛ", None) or t1.is_value("CHAPTER", None)): 
            ...
            return PartToken._new1027(t1, t1, PartToken.ItemType.CHAPTER)
        if (t1.is_value("ПРИЛОЖЕНИЕ", "ДОДАТОК") or t1.is_value("ПРИЛ", None) or t1.is_value("APPENDIX", None)): 
            ...
            return PartToken._new1027(t1, t1, PartToken.ItemType.APPENDIX)
        if (t1.is_value("ПРИМЕЧАНИЕ", "ПРИМІТКА") or t1.is_value("ПРИМ", None)): 
            is_short.value = (t1.length_char < 5)
            return PartToken._new1027(t1, t1, PartToken.ItemType.NOTICE)
        if (t1.is_value("ФОРМУЛА", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.FORMULA)
        if (t1.is_value("ТАБЛИЦА", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.TABLE)
        if (t1.is_value("ГРАФА", None) or t1.is_value("СТРОКА", None)): 
            if (t1.next0_ is not None and t1.next0_.is_value("ТАБЛИЦА", None)): 
                return PartToken._new1027(t1, t1.next0_, PartToken.ItemType.TABLEROW)
            return PartToken._new1027(t1, t1, PartToken.ItemType.TABLEROW)
        if (t1.is_value("СТОЛБЕЦ", None)): 
            if (t1.next0_ is not None and t1.next0_.is_value("ТАБЛИЦА", None)): 
                return PartToken._new1027(t1, t1.next0_, PartToken.ItemType.TABLECOLUMN)
            return PartToken._new1027(t1, t1, PartToken.ItemType.TABLECOLUMN)
        if (t1.is_value("ПРЕДЛОЖЕНИЕ", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SENTENCE)
        if (t1.is_value("СНОСКА", None)): 
            if (t1.previous is not None and t1.previous.is_value("ЗНАК", None)): 
                pass
            else: 
                return PartToken._new1027(t1, t1, PartToken.ItemType.FOOTNOTE)
        if (t1.is_value("СТАТЬЯ", "СТАТТЯ") or t1.is_value("СТ", None) or t1.is_value("ARTICLE", None)): 
            is_short.value = (t1.length_char < 3)
            return PartToken._new1027(t1, t1, PartToken.ItemType.CLAUSE)
        if (t1.is_value("ПУНКТ", None) or t1.is_value("П", None) or t1.is_value("ПП", None)): 
            is_short.value = (t1.length_char < 3)
            return PartToken._new1350(t1, t1, PartToken.ItemType.ITEM, (PartToken.ItemType.SUBITEM if t1.is_value("ПП", None) else PartToken.ItemType.UNDEFINED))
        if (t1.is_value("ПОДПУНКТ", "ПІДПУНКТ") or t1.is_value("ПОЛПУНКТА", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SUBITEM)
        if (t1.is_value("ПРЕАМБУЛА", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.PREAMBLE)
        if (t1.is_value("НАИМЕНОВАНИЕ", None) or t1.is_value("НАЗВАНИЕ", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.NAME)
        ...
        if (t1.is_value("РАЗДЕЛ", "РОЗДІЛ") or t1.is_value("РАЗД", None) or t1.is_value("SECTION", None)): 
            is_short.value = (t1.length_char < 5)
            return PartToken._new1027(t1, t1, PartToken.ItemType.SECTION)
        if (((t1.is_value("Р", None) or t1.is_value("P", None))) and t1.next0_ is not None and t1.next0_.is_char('.')): 
            if (prev is not None): 
                if (prev.typ == PartToken.ItemType.ITEM or prev.typ == PartToken.ItemType.SUBITEM): 
                    is_short.value = True
                    return PartToken._new1027(t1, t1.next0_, PartToken.ItemType.SECTION)
        if (t1.is_value("ПОДРАЗДЕЛ", "ПІДРОЗДІЛ") or t1.is_value("SUBSECTION", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SUBSECTION)
        if (t1.is_value("ПАРАГРАФ", None) or t1.is_value("§", None) or t1.is_value("PARAGRAPH", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.PARAGRAPH)
        if (t1.is_value("АБЗАЦ", None) or t1.is_value("АБЗ", None)): 
            is_short.value = (t1.length_char < 7)
            return PartToken._new1027(t1, t1, PartToken.ItemType.INDENTION)
        if (t1.is_value("СТРАНИЦА", "СТОРІНКА") or t1.is_value("СТР", "СТОР") or t1.is_value("PAGE", None)): 
            is_short.value = (t1.length_char < 7)
            return PartToken._new1027(t1, t1, PartToken.ItemType.PAGE)
        if (t1.is_value("ПОДАБЗАЦ", "ПІДАБЗАЦ") or t1.is_value("ПОДАБЗ", "ПІДАБЗ")): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SUBINDENTION)
        if (t1.is_value("ПОДПАРАГРАФ", "ПІДПАРАГРАФ") or t1.is_value("SUBPARAGRAPH", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SUBPARAGRAPH)
        if (t1.is_value("ПОДПРОГРАММА", "ПІДПРОГРАМА")): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.SUBPROGRAM)
        if (t1.is_value("ДОПСОГЛАШЕНИЕ", None)): 
            return PartToken._new1027(t1, t1, PartToken.ItemType.ADDAGREE)
        if (((t1.is_value("ДОП", None) or t1.is_value("ДОПОЛНИТЕЛЬНЫЙ", "ДОДАТКОВА"))) and t1.next0_ is not None): 
            ...
            if (tt.is_value("СОГЛАШЕНИЕ", "УГОДА")): 
                return PartToken._new1027(t1, tt, PartToken.ItemType.ADDAGREE)
        return None
    ...
    def try_attach_list(t : 'Token', in_bracket : bool=False, max_count : int=40) -> typing.List['PartToken']:
                            ...
                            if (li[len(li) - 1].end_token.next0_ == br.end_token): 
                                if (len(p.values) > 1): 
                                    ...
                                    while ii < len(p.values): 
                                        pp = PartToken._new1027(p.values[ii].begin_token, (p.end_token if ii == (len(p.values) - 1) else p.values[ii].end_token), p.typ)
            ...
            if (p0 is None): 
                ...
                if ((isinstance(tt, NumberToken)) and delim): 
                    ...
                    if (p.typ == PartToken.ItemType.CLAUSE or in_bracket): 
                        p0 = PartToken._new1027(tt, tt, PartToken.ItemType.CLAUSE)
                        ...
                        p0 = PartToken._new1027(tt, tt, res[len(res) - 1].typ)
                    if (p0 is None): 
                        break
                    vv = PartToken.PartValue._new1309(tt, tt, str(tt.value))
                    p0.values.append(vv)
                    vv.correct_value()
        ...
        while True:
            ...
            if (res[i].typ == PartToken.ItemType.PART and res[i + 1].typ == PartToken.ItemType.PART and len(res[i].values) > 1): 
                ...
                if ((v2 - v1) < 10): 
                    continue
                pt = PartToken._new1027(res[i].end_token, res[i].end_token, PartToken.ItemType.CLAUSE)
                pt.values.append(PartToken.PartValue._new1309(res[i].end_token, res[i].end_token, str(v2)))
    ...
    def can_be_next_narrow(self, p : 'PartToken') -> bool:
        ...
        if (self.typ == PartToken.ItemType.TABLE): 
            if (p.typ == PartToken.ItemType.TABLECOLUMN or p.typ == PartToken.ItemType.TABLEROW): 
                return True
        if (self.typ == p.typ): 
    ...
    def get_number(str0_ : str) -> int:
        if (Utils.isNullOrEmpty(str0_)): 
            return 0
        i = 0
        wrapi1379 = RefOutArgWrapper(0)
        inoutres1380 = Utils.tryParseInt(str0_, wrapi1379)
        i = wrapi1379.value
        if (inoutres1380): 
            return i
        ...
        if ((ord(ch)) < 0x80): 
            ...
            if ((ch == 'Z' and len(str0_) > 2 and str0_[1] == '.') and str.isdigit(str0_[2])): 
                n = 0
                wrapn1375 = RefOutArgWrapper(0)
                inoutres1376 = Utils.tryParseInt(str0_[2:], wrapn1375)
                n = wrapn1375.value
                if (inoutres1376): 
                    i += n
            ...
            if ((ch == 'Я' and len(str0_) > 2 and str0_[1] == '.') and str.isdigit(str0_[2])): 
                n = 0
                wrapn1377 = RefOutArgWrapper(0)
                inoutres1378 = Utils.tryParseInt(str0_[2:], wrapn1377)
                n = wrapn1377.value
                if (inoutres1378): 
                    i += n
        if (i < 0): 
    ...
    @staticmethod
    def _new1027(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'PartToken':
        res = PartToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1313(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool) -> 'PartToken':
        res = PartToken(_arg1, _arg2)
        res.typ = _arg3
        res.is_doubt = _arg4
        return res
    ...
    @staticmethod
    def _new1350(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'ItemType') -> 'PartToken':
        res = PartToken(_arg1, _arg2)
        res.typ = _arg3
        res.alt_typ = _arg4
        return res