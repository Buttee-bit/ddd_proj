...
class DecreeChangeValueReferent(Referent):
    ...
    def begin_char(self) -> int:
        ...
        inoutres1400 = Utils.tryParseInt(val, wrapn1399)
        n = wrapn1399.value
        if (inoutres1400): 
            return n
        return 0
    ...
    def end_char(self) -> int:
        ...
        if (val is None): 
            return 0
        n = 0
        wrapn1401 = RefOutArgWrapper(0)
        inoutres1402 = Utils.tryParseInt(val, wrapn1401)
        n = wrapn1401.value
        if (inoutres1402): 
            return n
        return 0
    ...
    @staticmethod
    def _new1033(_arg1 : 'DecreeChangeValueKind') -> 'DecreeChangeValueReferent':
