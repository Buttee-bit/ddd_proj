...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn3585 = RefOutArgWrapper(0)
        inoutres3586 = Utils.tryParseInt(self.__m_value, wrapn3585)
        n = wrapn3585.value
        if (inoutres3586): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new657(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
