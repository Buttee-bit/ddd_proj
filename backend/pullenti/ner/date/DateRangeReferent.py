...
class DateRangeReferent(Referent):
    ...
    @staticmethod
    def _new918(_arg1 : 'DateReferent', _arg2 : 'DateReferent') -> 'DateRangeReferent':
    ...
    @staticmethod
    def _new924(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_to = _arg1
        return res
    
    @staticmethod
    def _new925(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_from = _arg1
        return res