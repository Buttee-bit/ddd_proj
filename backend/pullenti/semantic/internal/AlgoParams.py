...
from backend.pullenti.semantic.internal.AlgoParam import AlgoParam
...
class AlgoParams:
    ...
    def _static_ctor():
        ...
        AlgoParams.PARAMS.append(AlgoParam._new3644("TransitiveCoef", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("NextModel", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("NgLink", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("List", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("VerbPlural", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("CaseAccord", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3644("MorphAccord", 1, 3, 1))
