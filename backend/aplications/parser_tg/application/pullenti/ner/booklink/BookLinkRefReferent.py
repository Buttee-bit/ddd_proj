...
class BookLinkRefReferent(Referent):
    ...
    def get_number_diff(r1 : 'Referent', r2 : 'Referent') -> int:
        ...
        n1 = 0
        n2 = 0
        wrapn1520 = RefOutArgWrapper(0)
        inoutres521 = Utils.tryParseInt(num1, wrapn1520)
        wrapn2522 = RefOutArgWrapper(0)
        inoutres523 = Utils.tryParseInt(num2, wrapn2522)
        n1 = wrapn1520.value
        n2 = wrapn2522.value
        if (not inoutres521 or not inoutres523): 
            return None
        return n2 - n1
    
    @staticmethod
    def _new511(_arg1 : 'Referent') -> 'BookLinkRefReferent':
